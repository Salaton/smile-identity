...
func (c *Client) EnhancedKYCAsyncVerification(ctx context.Context, input *KYCInput) (*AsyncResponse, error) {
	...
	err := c.makeRequest(ctx, http.MethodPost, "v1/async_id_verification", nil, nil, input, resp)
	if err != nil {
		return nil, err
	}
...
func (c *Client) EnhancedKYCVerification(ctx context.Context, input *KYCInput) (*KYCVerificationResult, error) {
	...
	err := c.makeRequest(ctx, http.MethodPost, "v1/id_verification", nil, nil, input, resp)
	if err != nil {
		return nil, err
	}
